...
@section('content')
    ...
    <!-- Main content -->
        <form action="{{ route('product.update',['id' => $productEdit->id]) }}" method="post"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <img src="{{ $productEdit->feature_image_path }}" id="image"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control tags_select_choose" name="tags[]" value=""
                                        multiple="multiple">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control tags_select_choose" name="collections[]"
                                        multiple="multiple">
                                    @foreach ($collections as $collection)
                                        <option value="{{ $collection->name }}" {{ $productEdit->getCollections->contains('id',$collection->id) ? 'selected' : ''}} >
                                            {{ $collection->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Content</label>
                                <textarea class="form-control" rows="15" name="contents" id="content"
                                          placeholder="Content...">{{ $productEdit->content }}</textarea>
                            </div>
                        </div>
