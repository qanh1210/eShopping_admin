        ...
        <div class="row">
            <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <img src="{{ $sliderEdit->image_path }}" id="image" style="max-width: 100px">
                            </div>
                        </div>
                    </div>
            </div>
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control my-editor @error('description') is-invalid @enderror " rows="15" name="description" placeholder="Description...">{{ $sliderEdit->description }}</textarea>
                    @error('description')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
